...
public class QuizViewModel extends ViewModel {
    ...
    private List<String> fileCapitalList;
    private List<String> quizCapitalsList;
    ...
    public QuizViewModel() {
        ...
        quizStatesList = new ArrayList<>();
        quizCapitalsList = new ArrayList<>();
        fileCapitalList = new ArrayList<>();
    }
    ...
    public static int getStatesInQuiz() {
        return STATES_IN_QUIZ;
    }
        ...
        try {
            for (String region : regionsSet) {
                ...
                for (String path : paths) {
                    this.fileNameList.add(path.replace(".jpg", ""));
                }
            }
        } catch (IOException e) {
    ...
    public List<String> getQuizStatesList() {
        return quizStatesList;
    }

    public void setQuizStatesList(List<String> quizStatesList) {
        this.quizStatesList = quizStatesList;
    }

    public void clearQuizStatesList(){
        this.quizStatesList.clear();
    }
    ...
    public String getNextState(){
        return quizStatesList.remove(0);
    }
}
